...
function FeaturesBlocks() {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <h2 className="h2 mb-4">dotflo introduces Campaigns</h2>
            <p className="text-xl text-gray-400">data works for you rather than the other way around.</p>
          </div>
  ...
  <h4 className="h4 mb-2">Insights</h4>
  <p className="text-lg text-gray-400 text-center">Visual and written information derived from machine learning.</p>
</div>
...
<div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
  ...
  <h4 className="h4 mb-2">Intelligence</h4>
  <p className="text-lg text-gray-400 text-center">Flexibility to test all of your hypotheses.</p>
</div>
...
<div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
  ...
  <p className="text-lg text-gray-400 text-center">Share campaigns across your organization for collaboration.</p>
</div>
...
<div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
  ...
  <h4 className="h4 mb-2">Data Source</h4>
  <p className="text-lg text-gray-400 text-center">Connect a variety of data sources ranging from xslv, csv, & database lists.</p>
</div>
...
<svg className="w-16 h-16 mb-4" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
  ...
  <h4 className="h4 mb-2">Automation</h4>
  <p className="text-lg text-gray-400 text-center">We are eager for your input to make your life easier. We build automation solutions tailored to your needs for free!</p>
</div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Analytics</h4>
              <p className="text-lg text-gray-400 text-center">Suite of analytics that provides complete awareness on what is going on within your company.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <p className="text-lg text-gray-400 text-center">On demand support for problems that our customers face.</p>
            </div>
