...
import logoImage from '../images/flo.png'; // Import the logo image
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="shrink-0 mr-4">
            ...
            <img src={logoImage} className="h-12 mx-auto mb-4 block pl-4 pt-4" alt="Logo" /> {/* Increase the height to h-24 */}
